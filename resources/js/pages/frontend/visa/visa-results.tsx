...
export default function VisaResults({ searchParams }: any) {
    ...
    return (
        <>
            <Head title="Visa Application - CloudTravel" />
                    ...
                    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                        <div style={{ background: '#f0f8ff', padding: '40px', borderRadius: '12px', maxWidth: '500px', margin: '0 auto' }}>
                            ...
                            <p style={{ fontSize: '13px', color: '#999', marginBottom: '20px' }}>
                                We will review your application and contact you within 24 hours via email or phone to confirm and provide further guidance.
                            </p>
                            <button
